...
export function OAuthButton({
  ...
  const getButtonClass = () => {
    if (isSupportedProvider(provider.provider)) {
      return cn(oauthButtonVariants({ provider: provider.provider }));
    }
    return "w-full";
  };
  ...
  return (
    <Button
      aria-label={t("signInWithProvider", { provider: provider.label })}
    ...
    >
      ...
      {t("signInWithProvider", { provider: provider.label })}
    </Button>
  );
}
