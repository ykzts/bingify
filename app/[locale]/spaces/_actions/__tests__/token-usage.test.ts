...
vi.mock("next-intl/server", () => ({
  getTranslations: vi.fn(() => {
    const translations: Record<string, string> = {
      ...
      errorEmailNotAllowed:
        "このメールアドレスではスペースに参加できません。許可されたドメイン・アドレスをご確認ください。",
      ...
      errorTwitchNotFollowing:
        "このスペースに参加するには、指定されたTwitch配信者をフォローする必要があります",
      errorTwitchNotSubscribed:
        "このスペースに参加するには、指定されたTwitch配信者のサブスクライバーである必要があります",
      errorTwitchVerificationFailed:
        "Twitch連携の確認に失敗しました。もう一度お試しください。",
      errorTwitchVerificationRequired:
        "このスペースに参加するには、Twitchアカウントの確認が必要です",
      errorUnauthorized: "認証が必要です。ログインしてください。",
      errorYouTubeNotMember:
        "このスペースに参加するには、指定されたYouTubeチャンネルのメンバーシップに加入する必要があります",
      errorYouTubeNotSubscribed:
        "このスペースに参加するには、指定されたYouTubeチャンネルを登録する必要があります",
      errorYouTubeVerificationFailed:
        "YouTube連携の確認に失敗しました。もう一度お試しください。",
      errorYouTubeVerificationRequired:
        "このスペースに参加するには、YouTubeアカウントの確認が必要です",
    };
