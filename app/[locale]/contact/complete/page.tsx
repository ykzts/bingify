...
export default async function ContactCompletePage({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-purple-100 via-pink-50 to-blue-100 p-4">
      <div className="w-full max-w-2xl rounded-lg border bg-white p-8 text-center shadow-lg">
        ...
        <h1 className="mb-4 font-bold text-3xl">{t("completeTitle")}</h1>

        <p className="mb-8 text-gray-600">{t("completeMessage")}</p>
        ...
        {email && (
          <div className="mb-8 rounded-lg bg-purple-50 p-6">
            ...
            <p className="break-all font-bold text-2xl text-purple-600">
              {email}
            </p>
          </div>
        )}
